...
const Pricing: FC<Props> = () => {
  return (
    <div className="max-w-full mx-auto w-full">
      <h1 className="font-Basic tracking-tighter md:tracking-tight text-center text-6xl text-white font-bold leading-snug pt-12">
        Pricing
      </h1>
        ...
        <div className="flex flex-col justify-center md:flex-row w-full h-full">
          ...
          <div className="w-full max-w-md sm:w-2/3 lg:w-1/3  h-full shadow-lg rounded-lg bg-secondary mx-auto my-auto">
            <div className="overflow-hidden h-full">
              <div className="text-center text-sm sm:text-md max-w-sm mx-auto mt-2 text-fourth px-8 lg:px-6 h-full">
                ...
                <h2 className="text-md text-fourth text-center py-10">
              ...
              <div className="flex items-center p-8 mt-auto uppercase">
                <button className="flex flex-row justify-center items-center rounded-md font-Basic md:text-lg tracking-tight md:tracking-tight font-semibold bg-tertiary shadow-neutral-900 shadow-lg w-full text-white px-6 py-3 hover:bg-primary">
          ...
          <div className="z-10 w-full max-w-md sm:w-2/3 lg:w-1/3 h-full lg:mx-4 shadow-lg rounded-lg bg-secondary mx-auto my-6 md:my-auto">
            ...
            <div className="text-center text-sm sm:text-md max-w-sm mx-auto mt-2 text-fourth px-8 lg:px-6">
              <h1 className="font-Basic text-white tracking-widest text-xl py-6 font-bold uppercase p-3 pb-0 text-center">
                3 Months
              </h1>
              <h2 className="text-md text-white text-center py-10">
              ...
              <div className="flex flex-col justify-center items-start mx-auto w-full md:w-10/12">
                ...
                <div className="flex flex-row justify-center items-center ">
                  <CgCheck className="text-4xl text-green-500" />
                  You save{" "}
                  <b className="mx-1 tracking-tight text-white text-lg">
                    20%
                  </b>{" "}
                  per month.
                </div>
